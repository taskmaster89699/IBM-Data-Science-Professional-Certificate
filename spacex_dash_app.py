...
def get_pie_chart(entered_site):
    ...
    if entered_site=='ALL':
        ...
        launch_df= launch_df.groupby(['Launch Site', 'class']).size().reset_index(name='class count')
        fig= px.pie(launch_df, values='class count',
        names='class',
        title= 'Successfull Launches for site:' + entered_site)
    return fig
